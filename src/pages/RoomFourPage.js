            ...
            <div class="p-5" style="width: 100%; height: 88vh;">
                <div class="rounded-5" style="width: 100%; height: 100%; background-color: rgba(14, 180, 252, 0.25);">
                    <div class="d-flex justify-content-evenly" style="width: 100%; height: 65%;">
                        <div class="d-flex flex-column m-auto rounded-5" style="width: 20rem; height: 28rem; background-color: rgba(14, 180, 252, 0.6);">
                        ...
                        <div class="d-flex flex-column m-auto rounded-5" style="width: 20rem; height: 28rem; background-color: rgba(14, 180, 252, 0.6);">
                            <div class="mt-5 mx-auto rounded-circle" style="width: 10rem; height: 10rem; background-color: white"></div>
                            <div class="m-auto text-center fs-1 text-white fw-bold">sangyhan</div>
                            <div class="m-auto text-center fs-1 text-white fw-bold">0승 0패</div>
                        </div>
                        <div class="d-flex flex-column m-auto rounded-5" style="width: 20rem; height: 28rem; background-color: rgba(14, 180, 252, 0.6);">
                            <div class="mt-5 mx-auto rounded-circle" style="width: 10rem; height: 10rem; background-color: white"></div>
                            <div class="m-auto text-center fs-1 text-white fw-bold">sham</div>
                            <div class="m-auto text-center fs-1 text-white fw-bold">2승 0패</div>
                        </div>
                    </div>
